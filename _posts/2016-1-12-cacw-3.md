...
如果想要进一步体会插值器带来的效果，我们还可以打开Android AVD或Genymotion虚拟机中，一个内置的APP叫**API Demos**，然后进入Views/Animation/Interpolators查看。值得一提的是该App还有其他值得一看的系统API调用示例。
